from main import valid, solve, find_empty
...
def main():
    ...
    text = font.render("Starting the Game", True, (0, 0, 0))
    screen.blit(text, (175, 245))

    font = pygame.font.SysFont('Courier New', 20)
    text = font.render("Please Wait...Generating Grid", True, (0, 0, 0))
    screen.blit(text, (125, 290))
    pygame.display.flip()
